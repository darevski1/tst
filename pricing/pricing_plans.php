    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mobile-block">
            ...
            <div class=" d-flex justify-content-end align-items-center col-sm-6 col-md-6 col-lg-6 mobile-block">
                ...
                <div> <a href="../login" type="button" class="btn black_btn  btn-sm ml-5">Not Enrolled</a> </div> 
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mobile-block">
            ...
            <div class=" d-flex justify-content-end align-items-center col-sm-6 col-md-6 col-lg-6 mobile-block">
                ...
                <div>
                    <a href="../login" type="button" class="btn black_btn  btn-sm ml-5">Not Enrolled</a> 
                </div> 
            </div>
        </div>
    </div>
