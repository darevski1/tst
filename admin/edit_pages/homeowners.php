...
<!doctype html>
<html lang="en">
<?=getHeader("Home Owners Program", "../.");?>

<body class="d-flex flex-column h-100">
    <?=GetEditHeader("Home Owners", 6);?>
    <div class="homeowners-hero">
        <div class="homeowners d-flex justify-content-center align-items-center">
    ...
    <div class="homeowners-block mb-5">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 col-sm-12 lblock-owners d-flex justify-content-center align-items-center">
                    <div class="wrap-text">
                ...
                <div class="col-md-6 col-sm-12 rblock-owners">
                    <div class="container-xl">
                    ...
                    <div class="container-xl d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div class="text-center mt-5">
                            <button class="btn btn-lg round-btn  main-btn btn-p mt-2 mb-4" type="submit">Contact Us
                            </button>
                        </div>
                        <div class="container-xl">
                            <input type="text" name="edit_page_values" class="form-control mt-5"
